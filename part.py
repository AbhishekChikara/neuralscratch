...
#We're also going to need to one-hot encode our y labels. One-hot encoding turns a class label n (out of k classes) into a vector of length k where index n is "hot" (1) while the rest are zero.
...
#randomnly initialize a parameter array of the size of full network's parameter
